...
O acúmulo de serrapilheira (gramas) foi positivamente influenciado pela altura e pelo número de folha dos indivíduos (Figura 2). Ou seja, a complexidade estrutural da planta funciona como um eficiente depósito de matéria orgânica. Neste trabalho nós não mensuramos a taxa de acúmulo ou mesmo a de decomposição da serrapilheira ao longo do tempo. Fica a dica caso você queira reproduzir este estudo em seu sistema de estudos. ;-) **ver como escrever a estatística dos glms**
...
dev.off()
```
![Figura 2. Relações entre o número de folhas (painel esquerdo), altura dos indivíduos (painel direito) a serrapilheira acumulada.](figs/fig2.png)

### *E quanto maior o acúmulo de serrapilheira, maior a riqueza de invertebrados (H2)*

A riqueza de invertebrados aumentou com o acúmulo de serrapilheira depositado entre as folhas de *E. brasiliensis* (Figura 3). Este resultado corrobora a importância da serrapilheira como um recurso para os invertebrados que ali vivem. Ali, muitos detrítivoros, como os colêmbolos encontram alimento. Outros táxons podem utilizar a serrapilheira como abrigo, seja da luz (fotofobia) ou mesmo de outro predadores, como as aranhas. 
...
Bem, nosso trabalho terminou por aqui. Vimos com este estudo que o material que cai imediatmente das árvores acima das manchas de *E. brasiliensis* são retidos entre suas folhas devido à sua arquitetura vegetal. Plantas mais altas e com maior número de folhas são capazes de acumular maior quantidade de serrapilheira. E quanto maior a quantidade de serrapilheira acumulada, maior é a riqueza de invertebrados associados. 

Note entretanto, que há uma série outras questões que podem ser exploradas daqui em diante neste mesmo super top sistema ecológico. Assim, próximos estudos podem: i) compararar a fauna associada à serripilheira de *E. brasiliensis*, com aquela presente na do solo adjacente (spoiler!); ii) avaliar as guiltas tróficas; iii) a composição e qualidade nutricional da serrilheira; iv) avaliar a partição de diversidade; e por aí vai. Ou seja, o céu é o limite! 
